...
def show_logo():
    ...
    subtitle = 'MC-Cracker V-0.9 (Universe)'
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if res.get('status') == '000000':
                ...
                # নাম না পেলে UID ব্যবহার করা
                display_name = real_name if real_name else uid
                ...
                # নাম প্রিন্ট করা (UID নয়)
                print(f'{BOLD}{color} {display_name} | Profile : {status} | Earned : {earn} {D}')
